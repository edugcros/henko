...
const getProductId = item =>
  item?._id || item?.id || item?.productId || item?.slug || ''
const getProductTitle = item =>
  item?.title || item?.name || item?.nombre || 'Producto'
const getProductBrand = item =>
  item?.marca || item?.brand || item?.manufacturer || 'Marca'
const getProductCategory = item =>
  item?.category || item?.categoryName || item?.categoria || ''
const getProductPrice = item =>
  Number(item?.finalPrice ?? item?.price ?? item?.precio ?? 0) || 0
const getOriginalPrice = item =>
  Number(item?.originalPrice ?? item?.price ?? item?.precio ?? 0) || 0
const getDiscountPercentage = item =>
  Number(item?.discountPercentage || item?.discount || 0) || 0
