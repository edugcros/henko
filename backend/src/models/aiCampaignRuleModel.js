...
const aiCampaignRuleSchema = new Schema(
  {
    ...
    type: { type: String, enum: ['abandoned_cart', 'lead_follow_up', 'post_purchase', 'winback'], required: true, index: true },
    ...
    trigger: {
      ...
      businessHours: { start: { type: String, default: '09:00' }, end: { type: String, default: '20:00' } },
    ...
    whatsappTemplate: {
      ...
      languageCode: { type: String, default: 'es_AR', trim: true },
    },
    useAiPersonalization: { type: Boolean, default: true },
    offer: { enabled: { type: Boolean, default: false }, couponCode: { type: String, default: '', trim: true, uppercase: true } },
    stats: { sent: { type: Number, default: 0 }, responses: { type: Number, default: 0 }, conversions: { type: Number, default: 0 } },
  },
  { timestamps: true },
)

aiCampaignRuleSchema.index({ tenantId: 1, type: 1, enabled: 1 })
const AiCampaignRule = mongoose.models.AiCampaignRule || mongoose.model('AiCampaignRule', aiCampaignRuleSchema)
