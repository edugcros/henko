  ...
  const spacingFields = [
    {
      ...
      max: 128,
      unit: 'px',
      description: 'Espacio entre secciones principales',
    },
    {
      key: 'container',
      ...
      max: 48,
      unit: 'px',
      description: 'Padding horizontal del layout',
    },
    {
      key: 'radius',
      ...
      max: 32,
      unit: 'px',
      description: 'Border radius por defecto',
    },
    {
      key: 'cardPadding',
      label: 'Padding de Tarjetas',
      min: 0,
      max: 32,
      unit: 'px',
      description: 'Padding interno de cards',
    },
  ]
